...
const config = {
  ...
  organizationName: 'easylogic', // Usually your GitHub org/user name.
  projectName: 'sapa-site', // Usually your repo name.
  trailingSlash: true,
  presets: [
    [
      'classic',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Sapa, Inc. Built with Docusaurus.`,
      },
      prism: {
